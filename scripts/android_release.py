...
def build_parser() -> argparse.ArgumentParser:
    ...
    artifact_parser.add_argument("--properties", type=Path, required=True)
    artifact_parser.add_argument("--apk", type=Path, required=True)
    artifact_parser.add_argument("--aab", type=Path, required=True)
    artifact_parser.add_argument("--fingerprint", required=True)
    artifact_parser.add_argument("--application-id", required=True)
    artifact_parser.add_argument("--apksigner", required=True)
    artifact_parser.add_argument("--aapt", required=True)
    artifact_parser.add_argument("--jarsigner", default="jarsigner")
    artifact_parser.add_argument("--keytool", default="keytool")
    artifact_parser.add_argument("--report", type=Path, required=True)
    artifact_parser.set_defaults(function=command_verify_artifacts)
